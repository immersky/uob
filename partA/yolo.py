...
class YOLO(object):
    _defaults = {
        ...
        "model_path": 'logs/lossRGB/last_epoch_weights.pth',
        "classes_path": 'model_data/mine.txt',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            draw.rectangle([tuple(text_origin), tuple(text_origin +    np.array([label_size, label_height])  )], fill=self.colors[c])
...
class YOLO_ONNX(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            box             = top_boxes[i]
            score           = top_conf[i]
            if score-0.99>0:            #if something like 0.995 ---->1.00
                score=0.99
